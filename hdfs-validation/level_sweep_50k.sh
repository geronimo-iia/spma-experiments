...
# Step 5 — Per-level threshold sweep on 50k model.
# Fix global T=0.2 (best for 50k), sweep level-threshold on levels 1 and 2.
#
# Usage: ./level_sweep_50k.sh
# Results saved to: data/results/level_sweep_50k/

SPMA=/Users/geronimo/dev/projects/libraries/spma/target/release/spma
DIR="$(cd "$(dirname "$0")" && pwd)"
MODEL="$DIR/data/model/hdfs_base.json"
RESULTS="$DIR/data/results/level_sweep_50k"
